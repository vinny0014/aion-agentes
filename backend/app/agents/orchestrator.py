...
PIPELINE = [
    ...
    ("aion-visual-editor", team.visual_editor_agent, False),
    ("image-rights-attribution", team.image_rights_attribution_agent, False),
    ("image-quality-auditor", team.image_quality_auditor_agent, False),
    ("homepage-art-director", team.homepage_art_director_agent, False),
    ("discover-social-visual-editor", team.discover_social_visual_editor_agent, False),
    ("aion-news-commander", team.aion_news_commander_agent, False),
