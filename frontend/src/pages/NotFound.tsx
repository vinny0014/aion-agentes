    ...
    <div className="min-h-screen">
      ...
      <main className="mx-auto max-w-3xl px-6 py-24 text-center">
        ...
        <h1 className="font-display text-6xl font-bold tracking-tight">
          Página não <span className="text-ultra">encontrada</span>
        </h1>
        <p className="mx-auto mt-5 max-w-md text-slateui">
          O agente Monitor verificou: este endereço não existe no AION.
          Ele pode ter sido movido ou nunca ter existido.
        </p>
        <div className="mt-8 flex justify-center gap-3">
          <Link to="/" className="btn-primary">Voltar ao início</Link>
          <Link to="/conteudos" className="btn-ghost">Ver conteúdos</Link>
        </div>
      </main>
    </div>
  );
